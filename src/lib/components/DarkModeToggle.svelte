...
<button
    class="flex items-center text-white dark:text-black py-1 px-2 rounded-full hover:bg-pbw-yellow/50"
    ...
    {#if dark}
        ...
        <span class="px-2 hidden lg: lg:inline">Dark mode</span>
    {:else}
        ...
        <span class="px-2 hidden lg:inline">Light mode</span>
    {/if}
</button>